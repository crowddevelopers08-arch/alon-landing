...
const STEPS = [
  {
    ...
    description:
      "Your journey begins with a detailed skin consultation, where our experts assess your skin type, concerns, and overall skin health using advanced diagnostic tools.",
    tag: "Consultation",
    icon: (
  ...
  },
  {
    ...
    description:
      "Using modern skin analysis technology, we identify the root causes of concerns such as pigmentation, acne, aging, or dullness - ensuring precision-led treatment.",
    tag: "Diagnosis",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    number: "03",
    title: "Personalised Skin Treatment Plan",
    description:
      "A customised luxury treatment plan is curated, combining advanced procedures like medi-facials, lasers, peels, or injectables - tailored to your skin goals.",
    tag: "Planning",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description:
      "Experience premium, clinically safe procedures performed under expert dermatological supervision, ensuring visible results with comfort and care.",
    tag: "Treatment",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    number: "05",
    title: "Follow-Up & Skin Progress Tracking",
    description:
      "Regular follow-ups help monitor your skin transformation, refine treatments, and maintain long-lasting, radiant results.",
    tag: "Follow-Up",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
