                    ...
                    <div className="space-y-3">
                            ...
                            <RevealOnScroll direction="left" delay={350} duration={700}>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-gray-600 text-lg leading-relaxed">
                                           Her approach to skin care focuses on identifying the root cause of skin concerns, recommending customised, stage-appropriate treatments, and ensuring long-term skin health and barrier restoration rather than temporary cosmetic fixes.
                                        </p>
                                    </div>
                                </div>
                            </RevealOnScroll>
