...
const FAQSection = () => {
  ...
  return (
    <section id='faq' className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          {/* Left Side - FAQ - slides from left */}
          <RevealOnScroll direction="left" duration={800}>
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-3 md:space-y-4 pt-4 md:pt-6">
                {faqs.map((faq, index) => (
                  <RevealOnScroll key={index} direction="left" delay={index * 100} duration={650}>
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <button
                        ...
                        className={`w-full px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between font-bold text-left transition-all duration-300 ${
                          openIndex === index ? 'text-black' : 'bg-white text-gray-900 hover:bg-gray-50'
                        }`}
          ...
          {/* Right Side - 2x2 Grid - slides from right with stagger */}
