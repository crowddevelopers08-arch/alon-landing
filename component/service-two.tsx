    ...
    >
      Call Now
          ...
          <div className="space-y-1 mt-4 lg:mt-0">
            {[
              { src: 'https://ik.imagekit.io/xivdiehvf/pushing.png',  alt: 'Progressive thinning',     label: 'Have progressive or advanced thinning' },
              { src: 'https://ik.imagekit.io/xivdiehvf/hourglass.png', alt: 'Limited results',          label: 'Have seen limited results with earlier treatments' },
              { src: 'https://ik.imagekit.io/xivdiehvf/man.png',       alt: 'Long-term restoration',    label: 'Are looking for long-term hair restoration' },
            ].map((feature, i) => (
