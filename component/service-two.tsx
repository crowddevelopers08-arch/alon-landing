...
const HealthcareFeaturesSection = () => {
    ...
    <section className="pt-6 px-4 sm:px-6 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-6 md:mb-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-center leading-tight max-w-4xl px-2" 
              style={{ color: '#9B7057'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-start">
          ...
          <div className="space-y-1 mt-4 lg:mt-0">
            {/* Feature 1 */}
            <div className="flex sm:flex-row items-center sm:items-center gap-4 sm:gap-5 p-4 sm:p-5 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 text-center sm:text-left">
  ...
  filter: "brightness(0) saturate(100%) invert(5%) sepia(20%) saturate(600%) hue-rotate(5deg) brightness(20%) contrast(105%)"
              ...
              <div>
                <h4 className="text-sm sm:text-md md:text-lg font-bold text-gray-900">Have progressive or advanced thinning</h4>
              </div>
            </div>
  ...
  filter: "brightness(0) saturate(100%) invert(5%) sepia(20%) saturate(600%) hue-rotate(5deg) brightness(20%) contrast(105%)"
              ...
              <div>
                <h4 className="text-sm sm:text-md md:text-lg font-bold text-gray-900">Have seen limited results with earlier treatments</h4>
              </div>
            </div>

            {/* Feature 3 */}
            <div className="flex sm:flex-row items-center sm:items-center gap-4 sm:gap-5 p-4 sm:p-5 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 max-sm:mb-5 text-center sm:text-left">
              <div className="flex-shrink-0">
                <img 
                  src="/man.png" 
                  alt="Long-term restoration icon"
                  className="w-8 h-8 sm:w-10 sm:h-10 md:w-10 md:h-10 object-contain"
                  style={{
  filter: "brightness(0) saturate(100%) invert(5%) sepia(20%) saturate(600%) hue-rotate(5deg) brightness(20%) contrast(105%)"
}}
              ...
              <div>
                <h4 className="text-sm sm:text-md md:text-lg font-bold text-gray-900">Are looking for long-term hair restoration</h4>
              </div>
            </div>
          </div>
        </div>
