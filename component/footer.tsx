          ...
          <div className="space-y-4">
           <div className="flex items-center bg-white rounded-lg px-3 py-2 w-max">
            ...
            <div className="flex items-center gap-4 pt-4">
              <a
                href="https://www.facebook.com/Anlonartsalon/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/anlon.artsalon/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                style={{ backgroundColor: "#9B7057" }}
              ...
              <a
                href="https://www.youtube.com/channel/UCddC29uY7wSndNrqMehKCDQ"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                style={{ backgroundColor: "#9B7057" }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs sm:text-sm text-gray-400 text-center sm:text-left">
              © {new Date().getFullYear()} Anlon Aesthetics. All rights
              reserved.
            </p>
